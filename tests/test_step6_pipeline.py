...
def test_full_pipeline():
    ...
    while elapsed < max_wait_time:
        ...
        # In a real scenario, you'd query the DB via API service for actual status
    ...
    # Step 4: Verify features were extracted (Mock response as API endpoint not yet implemented)
    print("\n4. Verifying feature extraction...")
    
    # In a real scenario, you'd call an API endpoint to get features or check DB
