...
def test_upload_file(client, mocker):
    ...
    mocker.patch('os.path.join', return_value=os.path.join(Config.VIDEO_WATCH_DIR, 'test.mp4'))
    ...
    mock_save.assert_called_once_with(os.path.join(Config.VIDEO_WATCH_DIR, 'test.mp4'))
